...
const sql = readFileSync(path.join(root, "supabase/migrations/129_board_directors.sql"), "utf8");
...
const verify = await fetch(
  `https://api.supabase.com/v1/projects/${projectRef}/database/query`,
  {
    ...
    body: JSON.stringify({
      query:
        "select table_name from information_schema.tables where table_schema='public' and table_name='board_directors'",
    }),
  },
);
