...
export const BoardMeetingsWorkspace = lazyWorkspace(() => import("./BoardMeetingsWorkspace"));
...
export const OrgChartWorkspace = lazyWorkspace(() => import("./OrgChartWorkspace"));
...
export const EngineeringTechnicalFilesWorkspace = lazyWorkspace(
  () => import("./EngineeringTechnicalFilesWorkspace"),
);
...
export const SoftwareSaasDashboardWorkspace = lazyWorkspace(
...
export const RealtimeVideoPipelineWorkspace = lazyWorkspace(
  () => import("./RealtimeVideoPipelineWorkspace"),
);
...
export const WolfSharkWorkspace = lazyWorkspace(
  () => import("@/components/wolf/shark/WolfSharkWorkspace"),
);
