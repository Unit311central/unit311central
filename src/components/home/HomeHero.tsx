  ...
  return (
    <div className="relative max-w-[800px]">
      ...
      <p className="mt-5 max-w-[760px] text-[15px] font-medium leading-[1.65] text-white/88 sm:mt-6 sm:text-[17px] sm:leading-[1.7]">
        For funded startups and SMEs tired of poor visibility, expensive disconnected systems, and
        hunting for answers across multiple logins.
      </p>
      <p className="mt-4 max-w-[760px] text-[15px] font-medium leading-[1.65] text-white/88 sm:text-[17px] sm:leading-[1.7]">
        Consolidate where it makes sense, connect what stays, and give leadership and employees one
        place to run the business — with live insight across operations, finance, and projects.
      </p>
...
export default function HomeHero() {
  return (
    <>
      <section className="relative bg-[#020617] sm:hidden">
        <div className="relative h-[clamp(240px,38svh,320px)] w-full overflow-hidden">
          <HeroVideoBackground />
        </div>
      ...
      <section className="relative hidden min-h-[100svh] overflow-hidden bg-[#020617] sm:block">
        ...
        <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-[1400px] items-end px-8 pb-20 pt-[6.5rem] lg:items-center lg:px-10 lg:pb-24 lg:pt-[120px]">
          <HeroCopy />
        </div>
      </section>
    </>
