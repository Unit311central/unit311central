  ...
  const panelBody = (
    ...
    >
      ...
      <div className="min-h-0 flex-1 space-y-4 overflow-y-auto px-5 py-4">
        {showSettings ? (
          <section className="rounded-xl border border-white/10 bg-[#0b1524]/60 p-3">
            ...
            <p className="mt-2 text-xs text-white/55">
              Conversations persist in Supabase when configured. The floating assistant stays mounted
              in the platform shell so context survives navigation.
            </p>
          ...
          <div className="mt-2 flex flex-wrap gap-1.5">
            <button
              ...
              onClick={() => {
                ...
                showNotice("Starting Show Me Around");
              }}
            ...
            <ChipButton
              ...
              onClick={() => void handleSend(undefined, "What is this page for? Use getPageGuide.")}
            />
            <ChipButton
              label="Explain the main controls"
              onClick={() =>
                void handleSend(
                  undefined,
                  "Explain the main controls on this page and highlight each one.",
                )
              }
            />
          </div>
        ...
        <section>
          <SectionLabel>Executive operating</SectionLabel>
          <div className="mt-2 flex flex-wrap gap-1.5">
            <ChipButton
              label="Daily brief"
            ...
            <ChipButton
              ...
              onClick={() => void handleSend(undefined, "Show smart insights with recommended actions.")}
            />
            <ChipButton
              label="Onboard a client"
              onClick={() => {
                startWorkflowGuide("onboard_client", 0);
                void handleSend(undefined, "I need to onboard a client. Guide me through the workflow.");
              }}
            />
            <ChipButton
              ...
              onClick={() => {
                ...
                void handleSend(undefined, "I need to create a project. Guide me through the workflow.");
              }}
            />
            <ChipButton
              label="Approve leave (confirm)"
              onClick={() =>
                setPendingConfirm({ kind: "approve_leave", label: "Approve Leave" })
              }
            />
          </div>
        </section>
        ...
        {!isPage ? (
          <>
            ...
            <section>
              ...
              <div className="mt-2 flex flex-wrap gap-1.5">
                {[...GENERATE_ACTIONS, ...FUTURE_ACTIONS].slice(0, 8).map((action) => (
                  <ChipButton
                    key={action}
                    label={action}
          ...
          <section>
            <SectionLabel>Future AI tools</SectionLabel>
            <p className="mt-2 text-xs text-white/50">
              Document analysis, voice, image understanding, board report generation, workflow
              automation, and multi-agent orchestration — framework ready.
            </p>
          </section>
        )}
          ...
          {pendingConfirm ? (
            <div className="mt-2 rounded-xl border border-amber-400/30 bg-amber-500/10 p-3">
              ...
              <p className="mt-1 text-xs text-white/75">
                AI recommends <span className="font-semibold">{pendingConfirm.label}</span>. You
                decide — nothing will run until you confirm, and writes remain blocked by design.
              </p>
