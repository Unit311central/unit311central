...
export function createInitialUsers(): ManagedUser[] {
  return [
    {
      id: "user-bcndrone",
      operatorLabel: "BCN Admin",
      fullName: "BCN Operations",
      username: "bcndrone",
      ...
      notes: "Primary internal operations account for the BCN Drone Center workspace.",
    },
    {
      id: "user-1",
      ...
      fullName: "User 1",
      username: "user1",
      email: "user1@barcelonadronecenter.com",
    ...
    },
    {
      ...
      fullName: "User 2",
      username: "user2",
      email: "user2@barcelonadronecenter.com",
    ...
    },
    {
      ...
      fullName: "User 3",
      username: "user3",
      email: "user3@barcelonadronecenter.com",
    ...
    },
    {
      ...
      fullName: "User 4",
      username: "user4",
      email: "user4@barcelonadronecenter.com",
    ...
    },
    {
      ...
      fullName: "User 5",
      username: "user5",
      email: "user5@barcelonadronecenter.com",
