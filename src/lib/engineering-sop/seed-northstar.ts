...
import { sopToDbInsert } from "@/lib/engineering-sop/mappers";
import { mapDbSop } from "@/lib/engineering-sop/mappers";
...
export async function seedNorthstarEngineeringSops(workspaceId: string): Promise<NorthstarSeedResult> {
