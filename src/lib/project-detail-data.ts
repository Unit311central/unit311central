...
const DETAILS: Record<string, ProjectDetail> = {
  ...
  default: {
    ...
    folderId: null,
    tasks: [
      { id: "t1", name: "Kick-off & scope sign-off", description: "", startDate: "2026-03-01", dueDate: "2026-03-05", progress: 100, resource: "Tom", milestone: true, critical: true },
      { id: "t2", name: "Site survey planning", description: "", startDate: "2026-03-06", dueDate: "2026-03-12", progress: 100, resource: "John", milestone: false, critical: true },
      { id: "t3", name: "Field capture", description: "", startDate: "2026-03-13", dueDate: "2026-03-20", progress: 75, resource: "Sarah", milestone: false, critical: true },
      { id: "t4", name: "Processing & QA", description: "", startDate: "2026-03-18", dueDate: "2026-03-28", progress: 40, resource: "Tom", milestone: false, critical: false },
      { id: "t5", name: "Client deliverables", description: "", startDate: "2026-03-25", dueDate: "2026-04-02", progress: 10, resource: "John", milestone: true, critical: true },
    ],
  },
};
