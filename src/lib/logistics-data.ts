...
const DEMO_LOGISTICS_SHIPMENTS: LogisticsShipment[] = [
  ...
  },
  {
    ...
    sender: "Northstar Industrial Technologies — Bristol",
    sentBy: "Oliver Hayes",
  ...
  },
  {
    ...
    origin: "RS Components — Corby, UK",
    destination: "Manchester, United Kingdom",
    recipient: "Northstar Industrial Technologies — Practice Ops",
    sender: "RS Components dispatch",
    sentBy: "Benjamin Bailey",
    contents: "PLC spare modules for Sheffield plant line",
    weightKg: 6.4,
  },
  {
    id: "shp-mag-out-005",
  ...
  },
  {
    ...
    origin: "Dell Technologies — Round Rock, US",
    destination: "Austin, United States",
    recipient: "Northstar Industrial Technologies — Import desk",
    sender: "Dell Enterprise dispatch",
    sentBy: "Leo Fisher",
    contents: "Laptop refresh batch — Austin office",
    weightKg: 11.2,
    notes: "Awaiting customs documentation review.",
  },
];

export const FEATURED_LONDON_NEW_YORK_ROUTE: FeaturedRouteSnapshot = {
  shipmentId: "shp-mag-man-aus-001",
  label: "Manchester → Austin",
  currentLeg: "air",
  progressPct: 62,
  currentLocationLabel: "Over the North Atlantic — airborne",
  origin: { name: "Manchester", lat: 53.4808, lng: -2.2426 },
  destination: { name: "Austin", lat: 30.2672, lng: -97.7431 },
  route: [
