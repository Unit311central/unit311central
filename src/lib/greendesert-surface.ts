...
export const GREENDESERT_WORKSPACE_LOGO_SRC = "/images/workspaces/greendesert/logo.svg";

export const GREENDESERT_WORKSPACE_LOGO_INTRINSIC_WIDTH = 220;
export const GREENDESERT_WORKSPACE_LOGO_INTRINSIC_HEIGHT = 48;
