...
export function overviewScreenshotSrc(slug: string | null | undefined): string {
  ...
  return `/images/overview/screenshots/${key}.png?v=live16`;
}
...
export function defaultOnwardAirOverviewContent(): OnwardAirOverviewEditableContent {
  return {
    ...
    questions: [
      ...
      "Can you get an answer to a question about your business — rapidly?",
      "Do you have complete visibility of your projects, people and finances?",
      "Do you find working with many software applications, disconnected, frustrating?",
      "Would you like to automate tasks, admin and easily create any report?",
    ],
