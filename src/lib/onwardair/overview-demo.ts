...
export function defaultOnwardAirOverviewContent(): OnwardAirOverviewEditableContent {
  return {
    ...
    questionsIntro: "",
    questions: [
      "Can you see the health of your business?",
      "Can you rapdily find info on your Business?",
      "Do you have visibility of  finances & projects?",
      "Would you like yout apps to share data?",
      "Would you like to automate more?",
    ],
