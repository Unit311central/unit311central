...
export const REFERENCE_PIPELINE_STAGES: ReferenceStageSeed[] = [
  ...
  },
  {
    ...
    component: "Internet propagation/routing",
    whatHappens: "IP packets traverse ISP and backbone networks toward WOLF cloud ingress.",
    detailedDescription:
      "BGP routing, peering, and geographic path from HQ to cloud region (eu-west-2 target). RTT, jitter, and packet loss TBD per provider measurements.",
    details: { connectionType: "Public Internet", propagationMedium: "Fibre" },
    pathKind: "video",
  },
  {
    pipelineSection: "Cloud Video Ingest",
    component: "WOLF cloud ingress",
    whatHappens: "Cloud network edge receives the inbound video stream.",
    detailedDescription:
      "Regional ingress (e.g. eu-west-2). Provider and architecture TBD — separate from Vercel application hosting.",
    details: { provider: "TBD", region: "eu-west-2", managed: true },
    pathKind: "video",
  },
  {
    pipelineSection: "Cloud Video Ingest",
    component: "Cloud network edge",
  ...
  },
  {
    ...
    details: { provider: "TBD", managed: true },
    pathKind: "video",
  },
  {
    pipelineSection: "Cloud Video Ingest",
    component: "Video ingest endpoint",
    whatHappens: "Managed service accepts the live video stream from HQ.",
    detailedDescription:
      "Authentication, stream handshake, and initial buffering at ingest. Protocol (SRT, RTSP, WebRTC, proprietary) TBD.",
    details: { streamingProtocol: "TBD", managedServiceName: "TBD", managed: true },
    pathKind: "video",
  },
  {
    pipelineSection: "Cloud Video Ingest",
    ...
    details: { bufferTimeMs: null, managed: true },
    pathKind: "video",
  },
  {
    pipelineSection: "Cloud Media Processing",
    component: "Initial stream processing",
  ...
  {
    pipelineSection: "Cloud Media Processing",
    component: "Real-time media distribution",
  ...
  },
  {
    ...
    details: { queueDepth: null, managed: true },
    pathKind: "ai",
    branchGroup: "ai-pipeline",
  },
  {
    pipelineSection: "AI Infrastructure",
    component: "GPU inference endpoint",
    whatHappens: "Managed GPU executes vision models on incoming video frames.",
    detailedDescription:
      "GPU provider, model, and runtime TBD (e.g. managed GPU service — not hard-coded to SageMaker/RunPod).",
    details: {
      gpuProvider: "TBD",
      gpuModel: "TBD",
      aiRuntime: "TBD",
  ...
  },
  {
    ...
    detailedDescription:
      "Application/API layer — typically Vercel-hosted Next.js API routes for WOLF workspace. Carries metadata and control, not live video bytes.",
    details: { streamingProtocol: "HTTPS", connectionType: "Public Internet" },
    pathKind: "metadata",
  },
  {
    pipelineSection: "WOLF Backend",
    ...
    details: { dataType: "JSON", streamingProtocol: "TBD" },
    pathKind: "overlay",
  },
  {
