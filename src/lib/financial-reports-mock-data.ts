...
export const NORTHSTAR_SEED_FINANCIAL_REPORTS: FinancialReportRecord[] = [
  {
    id: "nst-rpt-pl-fy25",
    name: "Profit & Loss — FY2025",
    ...
    primaryFormat: "PDF",
    status: "Ready",
    description: "Consolidated P&L for Northstar Industrial Technologies — SaaS and monitoring revenue.",
    organisation: "Northstar Industrial Technologies",
    department: "Finance",
  ...
  },
  {
    ...
    primaryFormat: "PDF",
    status: "Ready",
    description: "Assets, liabilities and equity snapshot at month end.",
    organisation: "Northstar Industrial Technologies Ltd",
    department: "Finance",
    project: "All projects",
    currency: "GBP",
    includeCharts: false,
  ...
  {
    id: "nst-rpt-cf-q2-26",
    name: "Cash Flow — Q2 2026",
    category: "Cash Flow",
    reportType: "Cash Flow",
    periodKind: "Quarterly",
    periodLabel: "Q2 2026",
    createdBy: "Elena Hart",
    lastGenerated: "2026-07-10",
    formats: ["PDF", "Excel"],
    primaryFormat: "Excel",
    status: "Ready",
    description: "Operating, investing and financing cash flows for Q2.",
    organisation: "Northstar Industrial Technologies",
    department: "Finance",
    project: "All projects",
    currency: "GBP",
  ...
  },
  {
    ...
    primaryFormat: "PDF",
    status: "Ready",
    description: "AR ageing by client — Sheffield, Peak District Breweries and portfolio.",
    organisation: "Northstar Industrial Technologies",
    department: "Finance",
    project: "All projects",
    currency: "GBP",
  ...
  },
  {
    ...
    primaryFormat: "Excel",
    status: "Ready",
    description: "Variance analysis against FY2026 operating plan.",
    organisation: "Northstar Industrial Technologies",
    department: "Finance",
    project: "All projects",
    currency: "GBP",
...
export function getSeedFinancialReports(options?: {
  ...
  if (demo) return NORTHSTAR_SEED_FINANCIAL_REPORTS;
  return SEED_FINANCIAL_REPORTS;
}
