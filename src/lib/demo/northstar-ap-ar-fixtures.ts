...
export type NorthstarPayableRow = {
  ...
  description: string;
  amount: number;
  currency: typeof NORTHSTAR_REPORTING_CURRENCY;
  dueDate: string;
  paid: boolean;
...
function buildNorthstarPayables(): NorthstarPayableRow[] {
  const rows: NorthstarPayableRow[] = [
    ...
    },
    {
      ...
      description: "Manchester office rent — August",
      amount: 5_000,
      currency: NORTHSTAR_REPORTING_CURRENCY,
      dueDate: "2026-08-18",
      paid: false,
      category: "opex",
      reference: "RENT-MAN-AUG-2026",
      journalEntryId: null,
      paymentJournalEntryId: null,
    },
    {
      ...
      description: "Bristol office rent — August",
      amount: 5_000,
      currency: NORTHSTAR_REPORTING_CURRENCY,
      dueDate: "2026-08-18",
      paid: false,
      category: "opex",
      reference: "RENT-BRI-AUG-2026",
      journalEntryId: null,
      paymentJournalEntryId: null,
    },
    {
      ...
      description: "Austin office rent — August",
      amount: 5_000,
      currency: NORTHSTAR_REPORTING_CURRENCY,
      dueDate: "2026-08-18",
      paid: false,
      category: "opex",
      reference: "RENT-AUS-AUG-2026",
      journalEntryId: null,
      paymentJournalEntryId: null,
    },
    {
