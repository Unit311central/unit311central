...
export const BOOK_FOCUS_GRID_ROW_1: readonly BookFocusGridColumn[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { kind: "item", label: "Expense Management" },
  ...
  },
  {
    ...
    items: [
      ...
      { kind: "item", label: "Minutes and Actions" },
      { kind: "item", label: "Risk Register" },
      { kind: "item", label: "Board s" },
  ...
  },
  {
    ...
    items: [
      ...
      { kind: "item", label: "Event Management" },
      { kind: "item", label: "Mailing list management" },
      { kind: "item", label: "Stories from the field" },
    ],
  },
  {
    ...
    items: [
      ...
      { kind: "item", label: "Software and SaaS" },
...
export const BOOK_FOCUS_GRID_ROW_2: readonly BookFocusGridColumn[] = [
  ...
  },
  {
    ...
    tone: "sky",
    items: [
      { kind: "item", label: "Role Management" },
