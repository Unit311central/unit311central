import { readEnvString, readEnvUrl } from "./env-value";
...
export const SITE_URL = readEnvUrl("NEXT_PUBLIC_SITE_URL", CENTRAL_SITE_URL);

export const SITE_NAME = readEnvString("NEXT_PUBLIC_SITE_NAME") ?? "Unit311";
export const SITE_EMAIL_DOMAIN = "unit311central.com";
export const SITE_LOGO_PATH = readEnvString("NEXT_PUBLIC_SITE_LOGO_PATH") ?? "/images/unit311central.svg";
export const SITE_OG_IMAGE_PATH =
  readEnvString("NEXT_PUBLIC_SITE_OG_IMAGE_PATH") ?? "/images/unit311central-hero.png";
